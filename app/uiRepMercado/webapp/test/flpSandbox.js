						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#RepresentacaoMercado-display"
								}
							}]
						}]
					}
					...
					"config": {
						"inbounds": {
							"RepresentacaoMercado-display": {
								...
								"action": "display",
								"description": "Representação de Mercado",
								"title": "RepresentacaoMercado",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ps.uiRepMercado",
									"url": sap.ui.require.toUrl("ps/uiRepMercado")
								}
							}
						}
					}
